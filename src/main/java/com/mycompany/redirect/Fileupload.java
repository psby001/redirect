...
public class Fileupload extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            DiskFileItemFactory diakfileItemfacetory = new DiskFileItemFactory();
            ServletFileUpload servletfileupload = new ServletFileUpload(diakfileItemfacetory);
            ...
            response.sendRedirect("resule.jsp");
        }
